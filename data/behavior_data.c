...
const BehaviorScript bhvMegaTree[] = {
    BEGIN(OBJ_LIST_POLELIKE),
    BILLBOARD(),
    OR_LONG(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_OPACITY_FROM_CAMERA_DIST)),
    SET_INT(oInteractType, INTERACT_POLE),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 12000),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_pole_base_loop),
    END_LOOP(),
...
const BehaviorScript bhvWhompKingBoss[] = {
    ...
    SET_INT(oHealth, 4), // 4 Health instead of 3
...
//NEW for handling bigtop cutscene
const BehaviorScript bhvBigtopCutscene[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    ...
    CALL_NATIVE(bhv_bigtop_cutscene_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvQuizMaster[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    //SET_INT(oInteractionSubtype, INT_SUBTYPE_N),
    SET_FLOAT(oGraphYOffset, 100),
    LOAD_ANIMATIONS(oAnimations, lakitu_seg6_anims_060058F8),
    ANIMATE(FAPPY_ANIM_DEFAULT),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 110, /*Height*/ 80),
    SET_INT(oIntangibleTimer, 0),
    //DROP_TO_FLOOR(),
    CALL_NATIVE(bhv_init_room),
    //SET_INT(oInteractionSubtype, INT_SUBTYPE_SIGN),
    CALL_NATIVE(bhv_quizmaster_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_quizmaster_loop),
    END_LOOP(),
};

const BehaviorScript bhvFinalFappy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    //SET_INT(oInteractionSubtype, INT_SUBTYPE_N),
    //SET_FLOAT(oGraphYOffset, 100),
    ...
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oInteractType, INTERACT_DAMAGE),
    SET_HITBOX(/*Radius*/ 90, /*Height*/ 90),
    SET_INT(oIntangibleTimer, 0),
    //SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    //DROP_TO_FLOOR(),
    //CALL_NATIVE(bhv_init_room),
    //SET_INT(oInteractionSubtype, INT_SUBTYPE_SIGN),
    SET_HOME(),
    CALL_NATIVE(bhv_final_fappy_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_final_fappy_loop),
    END_LOOP(),
};
