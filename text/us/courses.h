COURSE_ACTS(COURSE_BOB, _("100 IQ ULTRAQUIZ"),
       _("TAKE THE QUIZ")     , _("FOOTRACE WITH KOOPA THE QUICK") , _("SHOOT TO THE ISLAND IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_WF, _(" 2 INSIDE THE BIGTOP"),
       _("TIME FOR THE SHOW")        , _("KING CLOWN DEFEATED")    , _("BIGTOP FINAL ACT"),
...
COURSE_ACTS(COURSE_THI, _(" 13 FUNLAND"), // NEW CHANGED THI to FUNLAND
       _("ENJOY")      , _("THE TIP TOP OF THE HUGE ISLAND"), _("REMATCH WITH KOOPA THE QUICK"),
...
COURSE_ACTS(COURSE_RR, _(" 15 WHERE AM I"), // CHANGED
       _("HOW DID I GET HERE")  , _("THE BIG HOUSE IN THE SKY")      , _("COINS AMASSED IN A MAZE"),
