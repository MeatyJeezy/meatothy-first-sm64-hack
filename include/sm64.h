...
#define ACT_SUPERPOUND_LAND            0x00820237 // (0x037) CHANGED from ACT_UNUSED_037 to ACT_SUPERPOUND_LAND (ACT_FLAG_STATIONARY | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE)
...
#define ACT_SUPERPOUND                 0x008208A5 // (0x0A5 | ACT_FLAG_AIR | ACT_FLAG_ATTACKING | ACT_FLAG_INVULNERABLE) CHANGED from ACT_UNUSED_0A5 to ACT_SUPERPOUND
