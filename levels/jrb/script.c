...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -396, 245, -12, 0, 0, 0, 0x000B0000, bhvWarpPipe),
		OBJECT(MODEL_NONE, 584, 551, -3, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 584, 551, -3),
