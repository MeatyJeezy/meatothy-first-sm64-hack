...
DEFINE_LEVEL("OW1 C GROUNDS", LEVEL_CASTLE_GROUNDS, COURSE_THI, castle_grounds, outside, 20000, 0x00, 0x00, 0x00, _, sCamCastleGrounds) // CHANGED Testing changing the Course ID
