...
Vtx rr_dl_Plane_mesh_layer_5_vtx_0[4] = {
	{{ {-4004, 0, 4004}, 0, {-16, 1008}, {0, 127, 0, 255} }},
	{{ {4004, 0, 4004}, 0, {1008, 1008}, {0, 127, 0, 255} }},
	{{ {4004, 0, -4004}, 0, {1008, -16}, {0, 127, 0, 255} }},
	{{ {-4004, 0, -4004}, 0, {-16, -16}, {0, 127, 0, 255} }},
};

Gfx rr_dl_Plane_mesh_layer_5_tri_0[] = {
	gsSPVertex(rr_dl_Plane_mesh_layer_5_vtx_0 + 0, 4, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	gsSPEndDisplayList(),
};
...
Gfx rr_dl_Plane_mesh_layer_5[] = {
	gsSPDisplayList(mat_rr_dl_deathplane),
	gsSPDisplayList(rr_dl_Plane_mesh_layer_5_tri_0),
	gsSPEndDisplayList(),
};
