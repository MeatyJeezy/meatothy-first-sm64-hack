...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, 2372, -9192, 6971, 0, 0, 0, 0x000C0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, -206, 2629, 9498, 0, 0, 0, 0x000E0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, -114, -6296, 15771, 0, 0, 0, 0x00100000, bhvFadingWarp),
		OBJECT(MODEL_LAKITU, -70, -6284, 6608, 0, 180, 0, 0x00000000, bhvBigtopCutscene),
		OBJECT(MODEL_GOOMBA, -92, -8865, 9764, 0, 0, 0, 0x01010000, bhvGoomba),
		OBJECT(MODEL_STAR, 521, -9633, 6608, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 121, -9484, 6608, 0, 0, 0, 0x01000000, bhvStar),
		OBJECT(MODEL_STAR, -253, -9358, 6608, 0, 0, 0, 0x02000000, bhvStar),
		OBJECT(MODEL_NONE, 32, -9786, 2993, 0, 0, 0, 0x000A0000, bhvWarp),
		MARIO_POS(0x01, 0, 32, -9786, 2910),
		OBJECT(MODEL_WHOMP, -220, 1992, 8524, 0, 0, 0, 0x00000000, bhvWhompKingBoss),
