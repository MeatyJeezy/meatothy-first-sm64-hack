...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_CHAIN_CHOMP, -70, -5016, -3724, 0, 0, 0, 0x00000000, bhvBigtopCutscene),
		OBJECT(MODEL_NONE, -41, -9925, -8427, 0, 0, 0, 0x000A0000, bhvWarp),
		MARIO_POS(0x01, 0, -41, -9925, -8427),
