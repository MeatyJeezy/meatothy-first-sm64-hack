...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0xF0, LEVEL_CASTLE_GROUNDS, 0x01, 0x12, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_CASTLE_GROUNDS, 0x01, 0x0D, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_WF, 0x01, 0x0C, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0C, LEVEL_WF, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0D, LEVEL_WF, 0x01, 0x0E, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0E, LEVEL_WF, 0x01, 0x0D, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0F, LEVEL_WF, 0x01, 0x10, WARP_NO_CHECKPOINT),
		WARP_NODE(0x10, LEVEL_WF, 0x01, 0x0F, WARP_NO_CHECKPOINT),
		WARP_NODE(0x11, LEVEL_BITS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x12, LEVEL_CASTLE_GROUNDS, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x13, LEVEL_WF, 0x01, 0x13, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 422, -6636, 14657, 0, 0, 0, 0x00130000, bhvHardAirKnockBackWarp),
		OBJECT(MODEL_PIPE_RED, 422, -6810, 15107, 0, 0, 0, 0x00110100, bhvWarpPipe),
		OBJECT(MODEL_PIPE_BLUE, -662, -6810, 15083, 0, 0, 0, 0x00120000, bhvWarpPipe),
		OBJECT(MODEL_NONE, 2372, -9192, 5053, 0, 0, 0, 0x000C0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, -1030, 3299, 6694, 0, 144, 0, 0x000E0000, bhvFadingWarp),
		OBJECT(MODEL_NONE, -114, -6296, 13853, 0, 0, 0, 0x00100000, bhvFadingWarp),
		OBJECT(MODEL_LAKITU, -70, -6284, 4690, 0, 180, 0, 0x00000000, bhvBigtopCutscene),
		OBJECT(MODEL_GOOMBA, -92, -8865, 7846, 0, 0, 0, 0x01010000, bhvGoomba),
		OBJECT(MODEL_WOODEN_SIGNPOST, -130, -6810, 14727, 0, 180, 0, 0x00B80000, bhvMessagePanel),
		OBJECT(MODEL_STAR, 521, -9633, 4690, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 121, -9484, 4690, 0, 0, 0, 0x01000000, bhvStar),
		OBJECT(MODEL_STAR, -253, -9358, 4690, 0, 0, 0, 0x02000000, bhvStar),
		OBJECT(MODEL_NONE, 32, -9786, 1075, 0, 0, 0, 0x000A0000, bhvWarp),
		MARIO_POS(0x01, 0, 32, -9786, 992),
		OBJECT(MODEL_WHOMP, 64, 1782, 6606, 0, 0, 0, 0x00000000, bhvWhompKingBoss),
