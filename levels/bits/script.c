...
const LevelScript level_bits_entry[] = {
	...
	AREA(1, bits_area_1),
		...
		WARP_NODE(0xF1, LEVEL_WF, 0x01, 0x13, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BITS, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_LAKITU, -13494, -2310, -219, 0, 0, 0, 0x00000000, bhvFinalFappy),
		OBJECT(MODEL_LAKITU, -14153, 196, -50, 0, 0, 0, 0x00B20000, bhvCameraLakitu),
		OBJECT(MODEL_NONE, -14696, 240, -86, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -14696, 240, -86),
		OBJECT(MODEL_NONE, 10157, -1453, -957, 0, 0, 0, 0x500B0000, bhvWarp),
	...
	AREA(2, bits_area_2),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BITS, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x7A, LEVEL_BITDW, 0x02, 0x00, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 95, 2769, -74, 0, 0, 0, 0x00010000, bhvHighStrikerMachine),
		OBJECT(MODEL_NONE, 27, -4847, 8840, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 27, -4847, 8840),
		OBJECT(MODEL_WOODEN_SIGNPOST, -1549, 9464, -242, 0, -89, 0, 0x00B70000, bhvMessagePanel),
		TERRAIN(bits_area_2_collision),
		MACRO_OBJECTS(bits_area_2_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_WATER),
		SHOW_DIALOG(0x00, DIALOG_179),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	END_AREA(),
