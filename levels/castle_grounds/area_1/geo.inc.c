...
const GeoLayout castle_grounds_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 6072, -665, 1892),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_barrel_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Bench_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Buildings_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 10158, 11208, 5929, castle_grounds_dl_Cloudwarp_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, castle_grounds_dl_Cube_mesh_layer_7),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 635, 3501, 15423, castle_grounds_dl_Cylinder_mesh_layer_1),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Lamp_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Mainstreet_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_Mainstreet_mesh_layer_4),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 964, -737, 14507, castle_grounds_dl_planters_mesh_layer_4),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_planters_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_raleroad_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_raleroad_mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_Saloon_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_Saloon_mesh_layer_4),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 3058, 0, 6465, 0, 40, 0, castle_grounds_dl_SHoot_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_SHoot_mesh_layer_4),
		GEO_CLOSE_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_Wamlart_mesh_layer_4),
