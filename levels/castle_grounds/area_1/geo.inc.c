...
const GeoLayout castle_grounds_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_FORCE, castle_grounds_dl_Buildings_mesh_layer_0),
		...
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_grounds_dl_Houses_mesh_layer_4),
		...
		GEO_DISPLAY_LIST(LAYER_FORCE, castle_grounds_dl_Wamlart_mesh_layer_0),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
