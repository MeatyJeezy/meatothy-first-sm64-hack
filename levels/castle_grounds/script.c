...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(2, castle_grounds_area_2),
		...
		OBJECT(MODEL_BREAKABLE_BOX, -9715, -3826, -5730, 0, 0, 0, 0x00000000, bhvHighStrikerMachine),
		OBJECT(MODEL_PIANTA, -8296, -4054, -6139, 0, 0, 0, 0x00000000, bhvHighStrikerCarny),
